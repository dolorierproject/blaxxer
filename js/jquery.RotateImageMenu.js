	...
	var $listItems 		= $('#rm_container > ul > li'),
		...
		RotateImageMenu	= (function() {
			...
			var	timeDiff			= 300,
				...
				slideshowTime		= 3000,
				slideshowInterval,	
				//checks if the img are rotating
				isRotating			= false,
				//how many img completed each slideshow iteration
				completed			= 0,
				/*
				all our img have 310 of width and 465 of height.
				...
				*/
				rotateimg		= function(dir) {
					...
					$listItems.each(function(i) {
						...
						setTimeout(function() {
								//the img associated to this item
							var	$otherimg		= $('#' + $item.data('img')).children('img'),
								totalOtherimg	= $otherimg.length;
