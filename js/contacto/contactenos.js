...
var contact = {
	initEventHandlers	: function() {
		...
		$('.inplaceError',$('#formularioContacto')).bind('focus',function(){
			var $this 		= $(this);
		...
		$('#formularioContacto input,#formularioContacto textarea').keypress(function (e) {
		...
		$.ajax({
			   ...
			   success	: function(data,textStatus){
							  ...
							  if(data.result == '1'){
								  ...
								  $('#success_message').empty().html('Mensaje enviado');
